...
!
    ...
    use digclaw_module, only: i_h,i_hu,i_hv,i_hm,i_pb,i_hchi,i_hs,i_ent,i_hf,i_hs
    ...
    do j=1-mbc,my+mbc
        do i=1-mbc,mx+mbc
            ...
            call qfix(q(i_h,i,j),q(i_hu,i,j),q(i_hv,i,j),q(i_hm,i,j),q(i_pb,i,j),q(i_hchi,i,j),q(i_hf,i,j),q(i_hs,i,j),u,v,m,chi,rho,gz)
