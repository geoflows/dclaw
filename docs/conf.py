...
This page contains auto-generated API reference documentation for D-Claw [#f1]_.

Refer to the User Guide and other narrative documentation for background
information, installation instructions, and examples.
