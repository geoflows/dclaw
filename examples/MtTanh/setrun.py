...
#------------------------------
    ...
    clawdata.upper[0] = 20.0e3

    clawdata.lower[1] = -5.0e3
    clawdata.upper[1] =  5.0e3
    ...
    # dx = dy = 2', 10", 2", 1/3":
    amrdata.refinement_ratios_x = [10,10]
    amrdata.refinement_ratios_y = [10,10]
    amrdata.refinement_ratios_t = [10,10]
