...
r0 = 0.0  # left boundary (center of radially symmetric)
r1 = 1100.0  # top of landslide
r2 = 1300.0
r3 = 1600.0  # toe of landslide
r4 = 2000.0  # start of flat
r5 = 5000.0 * sqrt(2)  # right boundary for radial coordinate
...
m1d_func = interp1d(rr, etar, bounds_error=False, fill_value=0.0)
...
def maketopo():
    ...
    topotools.topo3writer(
        outfile, mfrac, xlower, xupper, ylower, yupper, nxpoints, nypoints
    )
